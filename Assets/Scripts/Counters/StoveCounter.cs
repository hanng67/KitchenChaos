...
public class StoveCounter : BaseCounter, IHasProgress
{
    ...
    private void FryingTimer_OnValueChanged(float previousValue, float newValue)
    {
        ...
        {
            progressNomalized = fryingTimer.Value / fryingTimerMax
        });
    }
    ...
    private void BurningTimer_OnValueChanged(float previousValue, float newValue)
    {
        ...
        OnProgressChanged?.Invoke(this, new IHasProgress.ProgressChangedEventArgs
        {
            progressNomalized = burningTimer.Value / burningTimerMax
        });
    }
    ...
    private void SetFryingRecipeSOClientRpc(int kitchenObjectSOIndex)
    {
        ...
        fryingRecipeSO = GetFryingRecipeSOForInput(kitchenObjectSO);
    }
    ...
    private void SetBurningRecipeSOClientRpc(int kitchenObjectSOIndex)
    {
        ...
        burningRecipeSO = GetBurningRecipeSOForInput(kitchenObjectSO);
    }
